    ...
    children: [
      {
        ...
        title: 'List',
        icon: IconPoint,
        href: '/apps/request/list',
      },
      {
        id: uniqueId(),
        title: 'Create',
        icon: IconPoint,
        href: '/apps/request/create',
      },
      {
        id: uniqueId(),
        title: 'Detail',
        icon: IconPoint,
        href: '/apps/request/detail/PineappleInc.',
      },
      {
        id: uniqueId(),
        title: 'Edit',
        icon: IconPoint,
        href: '/apps/request/edit/PineappleInc.',
      },
    ],
  },
  {
