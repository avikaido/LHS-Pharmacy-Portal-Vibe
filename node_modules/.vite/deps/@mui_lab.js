...
} from "./chunk-RZJQCCPN.js";
import {
  TabList_default
} from "./chunk-24DHFU3C.js";
import {
  TabContext,
  getPanelId,
  getTabId,
  useTabContext
} from "./chunk-IFQJFAIN.js";
import {
  AlertTitle_default,
  Alert_default,
  AvatarGroup_default,
...
} from "./chunk-F2E4WU45.js";
import {
  useAutocomplete
} from "./chunk-G32TTWLB.js";
import "./chunk-A3VKKCEX.js";
...
true ? TimelineItem.propTypes = {
   ...
   */
  position: import_prop_types6.default.oneOf(["alternate-reverse", "alternate", "left", "right"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var TreeItem = React45.forwardRef(function DeprecatedTreeItem() {
  warn24();
  return null;
});
...
var TreeView = React46.forwardRef(function DeprecatedTreeView() {
  warn25();
  return null;
});
...
var _excluded8 = ["children", "className", "component", "columns", "spacing", "sequential", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React47.forwardRef(function Masonry2(inProps, ref) {
  ...
  const handleResize = React47.useCallback((masonryChildren) => {
...
true ? Masonry.propTypes = {
   ...
   * @default false
   */
  sequential: import_prop_types8.default.bool,
  /**
