...
function quickresponse(text, level, ver) { // create QR and micro QR bar code symbol
	...
	var erc=[[2, 5, 6, 8,  7,10,15,20,26,18,20,24,30,18,20,24,26,30,22,24,28,30,28,28,28,28,30,30,26,28,30,30,30,30,30,30,30,30,30,30,30,30,30,30], // error correction words L
	        [99, 6, 8,10, 10,16,26,18,24,16,18,22,22,26,30,22,22,24,24,28,28,26,26,26,26,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28], // M
...
const QR = quickresponse;
const DataMatrix = datamatrix;

export { QR, DataMatrix, quickresponse, datamatrix, aztec, pdf417, code128, toPath, toHtml };