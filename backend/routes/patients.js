...
import { buildPatientPayload } from '../services/events/payloadBuilders.js';
...
router.post('/', async (req, res) => {
    try {
        ...
        // Emit PatientCreated event to integration system
        const event = new DomainEvent({
            eventType: 'PatientCreated',
            aggregate: { patientId: created.id },
            payload: buildPatientPayload(created),
        });
